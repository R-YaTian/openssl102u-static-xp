...
mkdir C:\OpenSSL
perl Configure VC-WIN32 no-asm --prefix=C:/OpenSSL -D_WIN32_WINNT=0x0501 -D_USING_V110_SDK71_
call ms\do_ms
nmake -f ms\nt.mak
nmake -f ms\nt.mak install

cd /d C:\
7z a -t7z -m0=lzma -mx=9 -mfb=64 -md=32m -ms=on -sse OpenSSL-1.0.2u-XP.7z OpenSSL
